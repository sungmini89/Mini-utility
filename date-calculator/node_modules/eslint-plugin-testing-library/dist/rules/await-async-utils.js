    ...
    create(context, _, helpers) {
        ...
        return {
            ...
            CallExpression(node) {
                ...
                const isAsyncUtilOrKnownAliasAroundIt = helpers.isAsyncUtil(callExpressionIdentifier) ||
                ...
                const closestCallExpression = (0, node_utils_1.findClosestCallExpressionNode)(callExpressionIdentifier, true);
                ...
                if (references.length === 0) {
                    if (!(0, node_utils_1.isPromiseHandled)(callExpressionIdentifier)) {
                        context.report({
