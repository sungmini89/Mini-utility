...
const is_testing_library_module_1 = require("../utils/is-testing-library-module");
...
function detectTestingLibraryUtils(ruleCreate, { skipRuleReportingCheck = false } = {}) {
    return (context, optionsWithDefault) => {
        ...
        const isNodeComingFromTestingLibrary = (node) => {
            ...
            return (hasImportElementMatch &&
                (0, is_testing_library_module_1.isTestingLibraryModule)(importDeclarationName, customModuleSetting));
        };
        const helpers = {
        ...
        const detectionInstructions = {
            ImportDeclaration(node) {
                ...
                if ((0, is_testing_library_module_1.isOfficialTestingLibraryModule)(node.source.value)) {
                    importedTestingLibraryNodes.push(node);
                }
                const customModule = getCustomModule();
                if (!importedCustomModuleNode &&
                    (0, is_testing_library_module_1.isCustomTestingLibraryModule)(node.source.value, customModule)) {
                    importedCustomModuleNode = node;
                }
                if (!importedUserEventLibraryNode &&
                    node.source.value === utils_2.USER_EVENT_MODULE) {
            ...
            [`CallExpression > Identifier[name="require"]`](node) {
                ...
                if (args.some((arg) => (0, node_utils_1.isLiteral)(arg) &&
                    ...
                    (0, is_testing_library_module_1.isOfficialTestingLibraryModule)(arg.value))) {
                ...
                if (!importedCustomModuleNode &&
                    args.some((arg) => (0, node_utils_1.isLiteral)(arg) &&
                        typeof arg.value === 'string' &&
                        (0, is_testing_library_module_1.isCustomTestingLibraryModule)(arg.value, customModule))) {
                    importedCustomModuleNode = callExpression;
                }
                if (!importedCustomModuleNode &&
                    args.some((arg) => (0, node_utils_1.isLiteral)(arg) &&
                        typeof arg.value === 'string' &&
                        arg.value === utils_2.USER_EVENT_MODULE)) {
